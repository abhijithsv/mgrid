...
class Grid
{
    private:
        ...
        list<int>::iterator next_it(list<int>::iterator it, int n);
    ...
    public:
        ...
        // Constructor
        Grid(int num_dims, int* phy_grid, MPI_Comm g_comm, int g_id, int num_grids, int* a_grids);
